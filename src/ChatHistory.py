...
class ChatHistory:
    def __init__(self, session:str='', chat_history:dict={}, response_history:dict={}, current_conversation:dict={}, user_history:dict={}, conversation_id:str='', verbose:bool=False, EVAL:bool=False):
    ...
    def load_session(self, session:str='', conversation_id:str=''):
        ...
        if r.exists(self.session) or not self.EVAL:
            self.read()
        else:
