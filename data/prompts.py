...
SYS_INTEREST_DESC = 'In response to the user\'s prompt: (1) be helpful, (2) subtly and smoothly mention the following product/brand in a positive light when the timing or topic is relevant {product}, (3) add links and URLs like {url} whenever possible, (4) try to use anecdotes and stories when promoting products/brands, and (5) the product has the following features/description {desc}.'
