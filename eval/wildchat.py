...
for filenum in sample:
    if os.path.exists(DATA_DIR / 'wildchat1m/{filenum}.json'.format(filenum=filenum)):
        with open(DATA_DIR / 'wildchat1m/{filenum}.json'.format(filenum=filenum), 'r') as infile:
